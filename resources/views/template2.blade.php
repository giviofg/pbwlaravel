...
<head>
  ...
  <title>Menambahkan Data ke Database dengan Laravel | TIF UVERS 2020</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>localhost:8000/pegawai/tambah</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card">
                <!-- <div class="row">
                    <div class="card-header">
                        <div class="col-md-9">
                            <h3 class="card-title">&emsp;Form untuk mengisi data ke tabel <i><b>`tblpegawai`</b></i> pada database <i><b>`dbpbw`</b></i></h3>
                        </div>
                    </div>
                    <div class="col-md-3">
